...
from PyQt5.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QGroupBox, QButtonGroup, QRadioButton, \
    QPushButton, QLabel, QSpinBox, QApplication
...
#кнопки для варіантів відповідей
